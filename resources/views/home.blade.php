        ...
        <ul class="navbar-nav mr-auto">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownAfrica">
                    ...
                    @endphp
                    <a class="dropdown-item" href="{{ route('home', ['user' => $usrInfo->uuid, 'cca3' => $afCountry->cca3]) }}">{{ $afCountry->flag }} {{ $afrCountry }}</a>
                    @endforeach
                </div>
                @endif
            </li>
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownAmericas">
                    ...
                    @endphp
                    <a class="dropdown-item" href="{{ route('home', ['user' => $usrInfo->uuid, 'cca3' => $amCountry->cca3]) }}">{{ $amCountry->flag }} {{ $ameCountry }}</a>
                    @endforeach
                </div>
                @endif
            </li>
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownAsia">
                    ...
                    @endphp
                    <a class="dropdown-item" href="{{ route('home', ['user' => $usrInfo->uuid, 'cca3' => $asCountry->cca3]) }}">{{ $asCountry->flag }} {{ $asiCountry }}</a>
                    @endforeach
                </div>
                @endif
            </li>
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownEuropa">
                    ...
                    @endphp
                    <a class="dropdown-item" href="{{ route('home', ['user' => $usrInfo->uuid, 'cca3' => $euCountry->cca3]) }}">{{ $euCountry->flag }} {{ $eurCountry }}</a>
                @endforeach
                </div>
                @endif
            </li>
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownOceania">
                    ...
                    @endphp
                    <a class="dropdown-item" href="{{ route('home', ['user' => $usrInfo->uuid, 'cca3' => $ocCountry->cca3]) }}">{{ $ocCountry->flag }} {{ $oceCountry }}</a>
                @endforeach
                </div>
                @endif
            </li>
...
$.getJSON("{!! route('api.addresses.point', ['user' => $usrInfo->uuid, 'cca3' => $ctrInfo->cca3]) !!}", function(data){
    L.geoJson(data, {
