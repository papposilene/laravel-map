...
@section('title', @ucfirst(__('app.newCat')))
@section('css-file')
...
<div class="row d-flex justify-content-center">
    <h1 class="col-6 h2 mb-3">
        <i class="fas fa-folder-plus" aria-hidden="true"></i> @ucfirst(__('app.newCat'))
    </h1>
</div>
@if ($errors->any())
<div class="row d-flex justify-content-center">
        ...
        <form action="{{ route('category.store') }}" method="POST">
            ...
            <div class="">
                <p class="text-justify">
                    @ucfirst(__('app.newCatInstruction'))
                </p>
            </div>
            <div class="input-group mb-3">
                ...
                <input type="text" name="name" class="form-control border-secondary" autocomplete="off" placeholder="@ucfirst(__('app.formCategory'))" aria-label="@ucfirst(__('app.category'))" aria-describedby="input-category" />
            </div>
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                    <span class="input-group-text border-secondary" id="input-icon"><i class="fas fa-image" aria-hidden="true"></i></span>
                </div>
                <input type="text" name="icon" class="form-control border-secondary" autocomplete="off" placeholder="@ucfirst(__('app.formIcon'))" aria-label="@ucfirst(__('app.formIcon'))" aria-describedby="input-icon" />
            </div>
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                    <span class="input-group-text border-secondary" id="input-color"><i class="fas fa-palette" aria-hidden="true"></i></span>
                </div>
                <input type="text" id="color" name="color" class="form-control border-secondary" autocomplete="off" placeholder="@ucfirst(__('app.formColor'))" aria-label="@ucfirst(__('app.formColor'))" aria-describedby="input-color" />
